...
public class BurgerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cAdapter = new CustomAdapter(BurgerActivity.this,menuList);
        RecyclerView.LayoutManager cLayoutManager = new LinearLayoutManager(BurgerActivity.this, LinearLayoutManager.VERTICAL, false);
